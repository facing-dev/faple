...
export const HydrateHolder = Symbol('faple-hydrate-holder')
...
// export function getValidChildren(node: HTMLElement): Array<HTMLElement | Text | Comment> {
